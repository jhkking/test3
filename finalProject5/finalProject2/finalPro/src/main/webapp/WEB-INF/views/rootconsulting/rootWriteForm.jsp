...
<c:import url="../../../header.jsp"></c:import>
	<div class="rcontainer" style="margin-left:15%">

		<div class="stepwizard col-md-offset-1">

			<div class="stepwizard-row setup-panel">
				<div class="btn-circle-small"></div>
				<c:forEach var="i" begin="1" end="${diffDays+1}" step="1">
					<c:if test="${i eq 1}">
		...
		<!-- Consent begin -->
			<c:forEach var="i" begin="1" end="${diffDays+1}" step="1" >
			<input type="hidden" name="hidday" value="${i}">
				<div class="row setup-content" id="step-${i}">
					<div class="col-md-10 col-md-offset-1">
						<div class="col-md-12">
							<h3>Day ${i}</h3> 
							<form id="rootform${i}" enctype="multipart/form-data" method="POST" action="rootinsertLast.do">
							<div class="panel panel-default">
								...
								<div class="panel-body" >
									...
									<table border="0">
										<tr>
											<th>지역</th>
											<td>&nbsp;&nbsp;<input type="text"  class="na1" name="mr_nation1"
												></td>
											<th>　　　　세부지역</th>
							...
							<font size="3" style="color: #F89406;display:block">관광지</font>
							<hr style="margin-bottom: 15px; border-color: #F89406">
							<span class="span11"></span>
							<hr style="margin-bottom: 15px; border:0px solid white">
							<span style="display:block;height:20px;width:100%"><font size="3" style="color: #F89406;display:block">음식</font></span>
							<hr style="margin-bottom: 15px; border-color: #F89406">
							<span class="span22"></span>
							<hr style="margin-bottom: 15px; border:0px solid white">
							<span><font size="3" style="color: #F89406;display:block">숙박</font></span>
							<hr style="margin-bottom: 15px; border-color: #F89406">
							<span class="span33"></span><br><br><br><br><br><br><br><br>
							<div class="panel panel-default">
							<c:if test="${i eq 1 }">
										<b style="float: left; margin-top: 20px; margin-bottom: 10px; margin-left: 30px;">제목
											: <input type="text" size="50" name="mr_title" style="border: 0;height:40px" id="ftitleid1" >
										</b>
										</c:if>
										<c:if test="${i ne 1 }">
										<div class="d11"></div>
							...
							<textarea rows="5" cols="100" placeholder="내용 입력..." style="border:0;" name="mr_content"></textarea>
							<%-- <input type="hidden" name = "lastday" value="${diffDays+1}"> --%>
							<input type="hidden"  name="mr_writer" value="${loginUser.member_id}">
							<input type="hidden" name="mr_day"  value="${i}">
							<br><input type="file" class="btn btn-default" name="uploadFile" style="width:100%">
							</div>
							</div>
							...
							<!-- Split button -->
							<div class="btn-group">
								<c:if test="${i eq diffDays+1}">
									<!-- <button class="btn btn-primary nextBtn btn-lg pull-left"
										type="button">Back</button> -->
									<a onclick="submit1('${i}')" class="btn btn-success btn-lg pull-right" >Root Save</a>
									
								</c:if>
								<c:if test="${i ne diffDays+1}">
									<!-- <button class="btn btn-primary nextBtn btn-lg pull-left"
										type="button">Back</button> -->
									<button class="btn btn-primary nextBtn btn-lg pull-left" type="button" onclick="saveList('${i}');">Next</button>
						...
						success : function(data) {
							...
							if (json.list != null) {
								...
								$(".span11").html(
										spotHtml.replaceAll(
												"+", " "));
								$(".span11").attr('style','display:inline;width:360px;height:210px');
							}
						...
						success : function(data) {
							...
							if (json.list != null) {
								...
								$(".span22").html(
										foodHtml.replaceAll(
												"+", " "));
								$(".span22").attr('style','display:inline;width:360px;height:210px');
							}
							...
							if (json.list != null) {
								...
								$(".span33").html(
										hotelHtml.replaceAll(
												"+", " "));
								$(".span33").attr('style','display:inline;width:360px;height:210px');
							}
