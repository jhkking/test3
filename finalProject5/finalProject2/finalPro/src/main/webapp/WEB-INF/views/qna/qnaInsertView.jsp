...
<body>
	...
	<form action="qinsert.do" method="post" >
		<div id="contentForm">
			<input type="hidden" name="q_writer" value="${loginUser.member_id }">
				...
				<table class="table table-striped table-bordered">
					<thead>
						...
						<tr>
							...
							<td><input type="text" name="q_title" class="form-control"
								aria-describedby="basic-addon1"></td>
						</tr>
					</thead>
					<tbody>
						<tr>
							<td colspan="2"><textarea class="form-control" rows="15" name="q_content"></textarea></td>
						</tr>
