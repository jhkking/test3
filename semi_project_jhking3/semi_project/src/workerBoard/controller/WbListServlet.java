...
/**
 * Servlet implementation class WbListServlet
 */
@WebServlet("/wblist")
public class WbListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public WbListServlet() {
        super();
...
response.setContentType("text/html; charset=utf-8");
		...
		ArrayList<WbBoard> list = bservice.selectList(currentPage, limit);
	...
	//	if(!map.isEmpty()) {
		if(!list.isEmpty()) {
			view = request.getRequestDispatcher("views/wbboard/wbListView.jsp");
