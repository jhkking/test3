 ...
 */
@WebServlet("/myinfo2")
public class MemberDetailServlet2 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MemberDetailServlet2() {
        super();
	...
	if(member != null) {
			...
			RequestDispatcher view = request.getRequestDispatcher("views/member/memberModify.jsp"); //이 결과를 받아줄 view파일 명을 적어주면 됨(괄호 안에)
