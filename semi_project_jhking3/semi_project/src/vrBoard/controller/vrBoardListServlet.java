...
/**
 * Servlet implementation class vrBoardListServlet
 */
@WebServlet("/vrlist")
public class vrBoardListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public vrBoardListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<vrBoard> list = vservice.selectList(currentPage, limit);
