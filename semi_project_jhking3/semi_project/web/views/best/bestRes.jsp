...
<!-- Navigation -->
   ...
   <div class="container">
      ...
      <form action = "/semi/bestres">
         <button type = "submit" id="btn11" autofocus>편의시설</button>
         <input type = "hidden" name = "page" value =1>
   ...
   <div align="center">
      <ul class="pagination justify-content-center">
         <%
            if (currentPageres <= 1) {
         %>
         <li class="page-item"><a class="page-link" href="/semi/bestres?page=1"
         ...
         %>
         <li class="page-item"><a class="page-link" href="/semi/bestres?page=<%=currentPageres - 1%>"
            aria-label="Previous"> <span aria-hidden="true">&laquo;</span> <span
               class="sr-only">Previous</span>
         </a></li>
         <%
         ...
         %>
         <li class="page-item"><a class="page-link" href="/semi/bestres?page=<%=p%>"><%=p%></a></li>
         <%
            }
            }
         %>
         ...
         %>
         <li
            class="page-item"><a class="page-link" href="/semi/bestres?page=<%=currentPageres + 1%>"
         ...
         %>
         <li
            class="page-item"><a class="page-link" href="/semi/bestres?page=<%=endPageres%>"
               aria-label="Next"> <span aria-hidden="true">&raquo;</span> <span
                  class="sr-only">Next</span>
            </a></li>
         <%
